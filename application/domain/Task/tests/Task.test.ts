...
describe('Task', () => {
    ...
    describe('markAsCompleted', () => {
        ...
        it('should not change a task that is already completed', () => {
            ...
            const task = new Task(taskId, message, createdAt, TaskStatus.Completed, new CompletedAt(completedDate));
            task.markAsCompleted();
            expect(task.getCompletedAt().getValue()).toEqual(completedDate);
        });
        ...
        it('should not change a task that is canceled', () => {
            ...
            const task = new Task(taskId, message, createdAt, TaskStatus.Canceled, new CompletedAt(canceledDate));
            task.markAsCompleted();
